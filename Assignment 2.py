class Set:
    ...
    def union( self, setB ):                 
        newSet = Set()  
        newSet._s.extend( self._s )
        for element in setB._s :
            if element not in self._s :
                newSet._s.append( element )
        return newSet                           
    ...
    def difference( self, setB ):
        ...
        newSet._s.extend( self._s )
        for element in setB._s :
            if element in self._s :
                newSet._s.remove( element )
        return newSet
